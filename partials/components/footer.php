  ...
  <div class="container footer__container">
    ...
    <div class="container__cols">
      <div class="container__l-col">
        <h2 class="h2 footer__h2"><?php echo translateRusUaEn('Меню', 'Меню', 'Menu') ?></h2>
      </div>
    ...
    <div class="footer__bottom">
      <div class="footer__copyright">Copyright © 2020. <?php echo translateRusUaEn('Все права защищены', 'Усі права захищено', 'All right reserved') ?></div>
